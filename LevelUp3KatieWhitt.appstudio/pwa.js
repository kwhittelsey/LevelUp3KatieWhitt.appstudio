...
const cacheName = 'LevelUp3KatieWhitt-2020-02-25 18:12:04.370328'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LevelUp3KatieWhitt'.length) === 'LevelUp3KatieWhitt') {
